...
@section('content')
    <section id="slider-part" class="slider-active">
        <div class="single-slider bg_cover pt-150" style="background-image: url({{ asset('site/images/slider/s-1.jpg') }})" data-overlay="4">
            <div class="container">
                <div class="row">
        ...
        <div class="single-slider bg_cover pt-150" style="background-image: url({{ asset('site/images/slider/s-2.jpg') }})" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont">
        ...
        <div class="single-slider bg_cover pt-150" style="background-image: url({{ asset('site/images/slider/s-3.jpg') }})" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont">
                            ...
                            <div class="col-lg-4">
                                <a href="#">
                                    <span class="singel-category text-center color-1">
                                        <span class="icon">
                                            <img src="{{ asset('site/images/all-icon/ctg-1.png') }}" alt="Icon">
                                        </span>
                                        <span class="cont">
                                            <span>Language</span>
                                        </span>
                            ...
                            <div class="col-lg-4">
                                <a href="#">
                                    <span class="singel-category text-center color-2">
                                        <span class="icon">
                                            <img src="{{ asset('site/images/all-icon/ctg-2.png') }}" alt="Icon">
                                        </span>
                                        <span class="cont">
                                            <span>Business</span>
                                        </span>
                            ...
                            <div class="col-lg-4">
                                <a href="#">
                                    <span class="singel-category text-center color-3">
                                        <span class="icon">
                                            <img src="{{ asset('site/images/all-icon/ctg-3.png') }}" alt="Icon">
                                        </span>
                                        <span class="cont">
    ...
    <section id="about-part" class="pt-65">
        ...
        <div class="about-bg">
            <img src="{{ asset('site/images/about/bg-1.png') }}" alt="About">
        </div>
    </section>
            ...
            <div class="row course-slied mt-30">
                    ...
                    <div class="singel-course">
                        ...
                        <div class="cont">
                            ...
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="#"><img src="{{ asset('site/images/course/teacher/t-1.jpg') }}" alt="teacher"></a>
                                </div>
                                <div class="name">
                ...
                <div class="col-lg-4">
                    <div class="singel-course">
                        <div class="thum">
                            <div class="image">
                                <img src="{{ asset('site/images/course/cu-3.jpg') }}" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="singel-course">
                        <div class="thum">
                            <div class="image">
                                <img src="{{ asset('site/images/course/cu-4.jpg') }}" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                        ...
                        <div class="cont">
                            ...
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="#"><img src="{{ asset('site/images/course/teacher/t-4.jpg') }}" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#"><h6>Mark anthem</h6></a>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="singel-course">
                        <div class="thum">
                            <div class="image">
                                <img src="{{ asset('site/images/course/cu-5.jpg') }}" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                        ...
                        <div class="cont">
                            ...
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="#"><img src="{{ asset('site/images/course/teacher/t-5.jpg') }}" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#"><h6>Mark anthem</h6></a>
                                </div>
    ...
    <section id="video-feature" class="bg_cover pt-60 pb-110" style="background-image: url({{ asset('site/images/bg-1.jpg') }})">
        <div class="container">
                        ...
                        <ul>
                            <li>
                                <div class="singel-feature">
                                    <div class="icon">
                                        <img src="{{ asset('site/images/all-icon/f-1.png') }}" alt="icon">
                                    </div>
                                    <div class="cont">
                            ...
                            <li>
                                <div class="singel-feature">
                                    <div class="icon">
                                        <img src="{{ asset('site/images/all-icon/f-2.png') }}" alt="icon">
                                    </div>
                                    <div class="cont">
                            ...
                            <li>
                                <div class="singel-feature">
                                    <div class="icon">
                                        <img src="{{ asset('site/images/all-icon/f-3.png') }}" alt="icon">
                                    </div>
                                    <div class="cont">
                                        <h4>Books & Library</h4>
                                        <p>Gravida nibh vel velit auctor aliquetn auci elit cons solliazcitudirem sem quibibendum sem nibhutis.</p>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="singel-teachers mt-30 text-center">
                                    <div class="image">
                                        <img src="{{ asset('site/images/teachers/t-1.jpg') }}" alt="Teachers">
                                    </div>
                                    <div class="cont">
                            ...
                            <div class="col-sm-6">
                                <div class="singel-teachers mt-30 text-center">
                                    <div class="image">
                                        <img src="{{ asset('site/images/teachers/t-2.jpg') }}" alt="Teachers">
                                    </div>
                                    <div class="cont">
                            ...
                            <div class="col-sm-6">
                                <div class="singel-teachers mt-30 text-center">
                                    <div class="image">
                                        <img src="{{ asset('site/images/teachers/t-3.jpg') }}" alt="Teachers">
                                    </div>
                                    <div class="cont">
                            ...
                            <div class="col-sm-6">
                                <div class="singel-teachers mt-30 text-center">
                                    <div class="image">
                                        <img src="{{ asset('site/images/teachers/t-4.jpg') }}" alt="Teachers">
                                    </div>
                                    <div class="cont">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="singel-publication mt-30">
                        <div class="image">
                            <img src="{{ asset('site/images/publication/p-1.jpg') }}" alt="Publication">
                            <div class="add-cart">
                                <ul>
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="singel-publication mt-30">
                        <div class="image">
                            <img src="{{ asset('site/images/publication/p-2.jpg') }}" alt="Publication">
                            <div class="add-cart">
                                <ul>
                                    <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                    <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="singel-publication mt-30">
                        <div class="image">
                            <img src="{{ asset('site/images/publication/p-3.jpg') }}" alt="Publication">
                            <div class="add-cart">
                                <ul>
                                    <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                    <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="singel-publication mt-30">
                        <div class="image">
                            <img src="{{ asset('site/images/publication/p-4.jpg') }}" alt="Publication">
                            <div class="add-cart">
                                <ul>
                                    <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                    <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
    ...
    <section id="testimonial" class="bg_cover pt-115 pb-115" data-overlay="8" style="background-image: url({{ asset('site/images/') }}/bg-2.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
            ...
            <div class="row testimonial-slied mt-40">
                <div class="col-lg-6">
                    <div class="singel-testimonial">
                        <div class="testimonial-thum">
                            <img src="{{ asset('site/images/testimonial/t-1.jpg') }}" alt="Testimonial">
                            <div class="quote">
                ...
                <div class="col-lg-6">
                    <div class="singel-testimonial">
                        <div class="testimonial-thum">
                            <img src="{{ asset('site/images/testimonial/t-2.jpg') }}" alt="Testimonial">
                            <div class="quote">
                                <i class="fa fa-quote-right"></i>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="singel-testimonial">
                        <div class="testimonial-thum">
                            <img src="{{ asset('site/images/testimonial/t-3.jpg') }}" alt="Testimonial">
                            <div class="quote">
                                <i class="fa fa-quote-right"></i>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="singel-news mt-30">
                        <div class="news-thum pb-25">
                            <img src="{{ asset('site/images/news/n-1.jpg') }}" alt="News">
                        </div>
                        <div class="news-cont">
                            <ul>
                ...
                <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="news-thum mt-30">
                                    <img src="{{ asset('site/images/news/ns-1.jpg') }}" alt="News">
                                </div>
                            </div>
                            <div class="col-sm-8">
                    ...
                    <div class="singel-news news-list">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="news-thum mt-30">
                                    <img src="{{ asset('site/images/news/ns-2.jpg') }}" alt="News">
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="news-cont mt-30">
                    ...
                    <div class="singel-news news-list">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="news-thum mt-30">
                                    <img src="{{ asset('site/images/news/ns-3.jpg') }}" alt="News">
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="news-cont mt-30">
