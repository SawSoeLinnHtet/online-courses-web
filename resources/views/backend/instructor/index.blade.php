    ...
    <script>
        $(function () {
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.instructors.index') }}",
                columns: [
                    {
                        data: 'id',
                        name: 'id',
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            var editUrl = "{{ route('admin.instructors.edit', ':id') }}".replace(':id', row.id);
                            var deleteUrl = "{{ route('admin.instructors.destroy', ':id') }}".replace(':id', row.id);
                            var showUrl = "{{ route('admin.instructors.show', ':id') }}".replace(':id', row.id);
                            return `
                                <div class="dropdown">
